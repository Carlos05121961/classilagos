...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* CARROSSEL COM LOGO + MENU SOBRE AS IMAGENS DA REGIÃO */}
      <section>
          ...
          <div className="absolute inset-0 z-10 flex flex-col">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-4 pt-4">
              ...
              <nav className="hidden md:flex items-center gap-5 text-sm font-medium text-slate-900">
                ...
                <Link href="/veiculos" className="hover:text-blue-700">
                  Veículos
                </Link>
                <Link href="/nautica" className="hover:text-blue-700">
                  Náutica
                </Link>
                <Link href="/servicos" className="hover:text-blue-700">
                  Serviços
                </Link>
                <Link href="/turismo" className="hover:text-blue-700">
                  Turismo
                </Link>
                <Link href="/lagolistas" className="hover:text-blue-700">
                  LagoListas
                </Link>
