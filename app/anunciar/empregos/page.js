    ...
    <main className="max-w-4xl mx-auto px-4 py-10">
      ...
      <header className="mb-10">
        ...
        <p className="mt-2 text-sm md:text-base text-slate-600 max-w-2xl">
          ...
          Seu anúncio ficará visível para milhares de candidatos em toda a Região
          dos Lagos.
        </p>
      </header>
      ...
      <section className="bg-slate-50 border rounded-2xl shadow-sm p-5 md:p-7 mb-10">
        ...
        <ul className="space-y-2 text-sm text-slate-700">
          ...
          <li>• Caso tenha benefícios, adicione — isso atrai mais candidatos.</li>
          <li>• Descreva bem o que o profissional vai fazer no dia a dia.</li>
