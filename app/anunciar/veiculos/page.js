// app/anunciar/veiculos/page.js

import FormularioVeiculos from "../../components/forms/FormularioVeiculos";

export default function AnunciarVeiculosPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <header className="mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-2">
          Anunciar Veículo na Região dos Lagos
        </h1>
        <p className="text-sm md:text-base text-slate-600">
          Preencha os dados do seu veículo. Seu anúncio ficará disponível para
