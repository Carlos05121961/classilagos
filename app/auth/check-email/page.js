      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        ...
        <div className="px-6 py-7 space-y-4">
          <p className="text-sm text-slate-600">
            ...
            <span className="font-semibold">Classilagos</span>. Agora só falta
            confirmar seu e-mail para ativar seu anúncio e vinculá-lo à sua conta.
          </p>
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        ...
        <div className="px-6 py-7">
          <p className="text-sm text-slate-600">
            Aguarde um instante enquanto preparamos sua confirmação.
          </p>
        </div>
      </div>
    </div>
