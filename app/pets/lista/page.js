...
export default function PetsPage() {
  ...
  const anunciosRecentes = anuncios && anuncios.length > 0 ? anuncios.slice(0, 12) : [];
                  ...
                  >
                    ...
                    <div className="bg-slate-900 text-white px-3 py-2">
                      ...
                      <p className="text-[10px] text-slate-300">
                        ...
                        {classificarAnuncio(a) === "adocao" && "Adoção / Doação"}
                        {classificarAnuncio(a) === "achados" && "Achados e perdidos"}
                        {classificarAnuncio(a) === "servicos" && "Serviços pet & acessórios"}
                      </p>
                    </div>
                  </Link>
                );
