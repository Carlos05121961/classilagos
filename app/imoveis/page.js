...
export default function ImoveisPage() {
  ...
  // busca os anúncios de imóveis no Supabase
  useEffect(() => {
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-4 pb-10">
        ...
        {/* IMÓVEIS EM DESTAQUE – SÓ O QUE EXISTE NO BANCO */}
        <div className="mt-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-2">
              {destaques.map((anuncio) => {
                ...
                return (
                  ...
                  >
                    <div className="h-20 md:h-24 w-full bg-slate-100 flex items-center justify-center px-2">
                      <p className="text-[11px] md:text-xs font-semibold text-slate-800 text-center line-clamp-3">
                        {anuncio.titulo}
                      </p>
                    </div>
      ...
      {/* AQUI PODEM CONTINUAR NOTÍCIAS, LINKS ÚTEIS, MERCADO LIVRE, ETC */}
    </main>
  );
}
